# measuring the time it takes to extract TD features from the wellby data
...
# load data
wellby_data = pd.read_csv("../../data/Wellby/selected_ppg_data.csv")
fs = 50 # Wellby sampling frequency (50 Hz)
...
ppg_data = ppg_data[100:] # skip first 2 seconds
...
def extract_td_features(data):
    """Extract time-domain features for the Wellby dataset"""
