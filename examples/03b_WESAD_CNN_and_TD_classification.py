...
# Configuration
COMBINED_DATA_PATH = '../data/all_subjects_CNN_and_TD_features.csv'
RESULTS_PATH_ALL = '../results/WESAD/WESAD_CNN_and_TD_features_eval.csv'
RESULTS_PATH_CI = '../results/WESAD/WESAD_CNN_and_TD_features_eval_with_ci.csv'
